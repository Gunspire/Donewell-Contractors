...
function initialLead(): Lead {
  return {
    ...
    details:
      "Looking for a new block paving driveway (approx 45m²) with a contrasting border. Can you quote and advise on drainage? Best time to call: after 5pm.",
    receivedAt: nowTime(),
  };
}
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-slate-500">Donewell Contractors App • {lead.receivedAt}</span>
                </div>
