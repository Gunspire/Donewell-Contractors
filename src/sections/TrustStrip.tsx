...
export function TrustStrip() {
  ...
  > = [
    ...
    { icon: BadgeCheck, text: "Free Quotes" },
    { imageSrc: "/google-g.png", imageAlt: "Google", text: "4.9 Google Reviews" },
    { icon: CheckCircle2, text: "Written Guarantee" },
    { icon: Clock, text: "Fast Turnaround" },
    { icon: HardHat, text: "Proper Groundworks" },
    { icon: ThumbsUp, text: "Tidy, Respectful Team" },
    { icon: Building2, text: "Local Service" },
    { icon: Award, text: "Quality Finish" },
  ];
