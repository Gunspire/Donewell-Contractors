        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-5 text-white">
            ...
            <p className="text-blue-100/90 mt-4 text-lg leading-relaxed">
              Tell us what you need and we’ll come back with a clear, itemised quote. Send photos
              on WhatsApp for a quick rough estimate.
            </p>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100/90 text-sm mt-1">{COMPANY.phoneDisplay}</p>
                    <p className="text-blue-200 text-xs mt-1">Fast quotes • Friendly advice</p>
                  </div>
                </div>
              </a>

              <a
                href={`https://wa.me/${COMPANY.phoneRaw.replace("+", "")}?text=${encodeURIComponent(
                  `Hi ${COMPANY.name} — I'd like a free quote please.`
                )}`}
                target="_blank"
                rel="noreferrer"
                className="group rounded-2xl bg-white/10 border border-white/15 backdrop-blur px-5 py-4 hover:bg-white/15 transition"
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100/90 text-sm mt-1">{COMPANY.email}</p>
                    <p className="text-blue-200 text-xs mt-1">
                      Mon–Fri 8am–6pm • Weekend messages welcome
                    </p>
                  </div>
                </div>
              </a>
                    ...
                    <form onSubmit={handleFooterQuoteSubmit} className="space-y-4">
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          ...
                          <select className="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all bg-white">
                            <option>Block Paving Driveway</option>
                            <option>Patio / Paving</option>
                            <option>Driveway Extensions</option>
                            <option>Edging / Kerbs</option>
                            <option>Garden Walls / Brickwork</option>
                            <option>Drainage / Groundworks</option>
                          </select>
                        </div>
                        <div className="space-y-1.5">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <textarea
                          ...
                          placeholder="Tell us what you want done (size/area), and any preferences. Photos help if you have them."
                        />
                      </div>
