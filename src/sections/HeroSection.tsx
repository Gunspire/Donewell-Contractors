...
export function HeroSection() {
  const heroImages = [
    "/2024-10-25.webp",
    "/donewell/candidate-before-3.jpg",
    "/donewell/candidate-before.jpg",
  ];
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          <div className="lg:col-span-8">
            <div className="inline-flex items-center gap-2 bg-blue-600/20 border border-blue-500/30 rounded-full px-4 py-1.5 mb-6 backdrop-blur-sm">
              ...
              <span className="text-blue-100 text-sm font-medium">Driveways, Patios & Groundworks</span>
            </div>

            <h1 className="text-3xl lg:text-5xl font-bold text-white leading-tight mb-6">
              Premium <span className="text-blue-500">block paving</span> & patios. Fast quotes, tidy work,
              built to last.
            </h1>

            <p className="text-lg text-slate-300 mb-8 leading-relaxed max-w-xl">
              From full driveway installs to patios, garden features and drainage, we deliver
              clean lines, strong foundations and a finish that transforms kerb appeal.
            </p>
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-slate-700/50">
              <div className="flex flex-col max-w-[200px]">
                <p className="text-slate-200 italic text-sm mb-2">
                  {"Transformed our driveway. Tidy team, great finish, and fast turnaround."}
                </p>
