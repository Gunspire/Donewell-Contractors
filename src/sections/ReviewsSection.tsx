    ...
    <section id="reviews" className="py-20 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              text: "Fantastic job on our block paving driveway. Clear quote, great communication, and the finish looks spot on.",
              author: "Sarah Jenkins",
              location: "Surrey",
              date: "2 weeks ago",
            },
            {
              text: "We had a patio laid and some levels sorted near the back door. Tidy team, on time, and the patio looks amazing.",
              author: "Mike Thompson",
              location: "South London",
              date: "1 month ago",
            },
            {
              text: "Great workmanship and very respectful of the property. Everything was kept clean and the driveway has transformed the front of the house.",
              author: "David Clarke",
              location: "Kent",
              date: "2 months ago",
            },
