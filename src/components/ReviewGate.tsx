...
import { COMPANY, GOOGLE_REVIEW_URL } from "../config/company";
      ...
      <div className="rounded-3xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        <div className="px-6 sm:px-10 py-10 sm:py-12">
          <div className="max-w-xl">
            <p className="text-sm font-semibold text-blue-700">{COMPANY.name}</p>
              ...
              <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-5">
                ...
                <form onSubmit={submitFeedback} className="mt-5 space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <Button variant="white" as="a" href={`tel:${COMPANY.phoneRaw}`}>
            ...
            {step === "thanks" && (
              <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-5">
                ...
                <div className="mt-4 flex flex-col sm:flex-row gap-3">
                  ...
                  <Button as="a" href={`tel:${COMPANY.phoneRaw}`}>
                    Call {COMPANY.phoneDisplay}
                  </Button>
                </div>
              </div>
